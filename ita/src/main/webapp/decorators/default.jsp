...
<link href="${url}/resources/css/bootstrap-theme.min.css"
	rel="stylesheet" />

<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/itsSpring.css" />
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/flip-scroll.css" />
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/signin.css" />
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/menu.css" />
...
<!-- jqcron expression -->
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/jqdemo.css" />
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/jqreset.css" />
<link rel="stylesheet" type="text/css"
	href="${url}/resources/css/jqCron.css" />
